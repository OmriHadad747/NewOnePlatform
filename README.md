# AI Project-Manager Agent -- Phase 1

Phase 1 validates the AI core's "memory": does it keep an accurate,
conflict-aware picture of a project across a long sequence of events?
This repo currently implements the foundation that makes that question
testable -- no LLM yet.
